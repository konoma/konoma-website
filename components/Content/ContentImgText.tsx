...
const ContentImgText: React.FC<ContentImgProps> = (props) => {
  ...
  return (
    <section
      className={`container mx-auto px-2 lg:px-3 space-y-3 lg:space-y-0 \
                lg:grid lg:grid-cols-8 lg:grid-rows-1 lg:auto-rows-min lg:gap-3
                ${className}`}
    >
      <div
        className={`space-y-2 lg:row-start-1 lg:row-end-2 lg:self-center
                    ${
                      imgOrientation === "left"
                        ? "lg:col-start-6 lg:col-end-9"
